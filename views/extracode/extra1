...
function updatePositions() {
    ...
    for (var e = document.body.scrollTop / 1250, a = Math.sin(e), r = Math.cos(e), n = 0; n < items.length; n++) {
        var i = a * Math.cos(n % 5) + r * Math.sin(n % 5);
        items[n].style.left = items[n].basicLeft + 100 * i + "px"
    }
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(e) {
        ...
        function n(e) {
            for (var a = i.length, n = r(i[0], e), t = i[0].offsetWidth + n + "px", o = 0; a > o; o++) i[o].style.width = t
        }
        window.performance.mark("mark_start_resize"), a(e);
        var i = document.getElementsByClassName("randomPizzaContainer");
        n(e), window.performance.mark("mark_end_resize"), window.performance.measure("measure_pizza_resize", "mark_staort_resize", "mark_end_resize");
...
window.requestAnimationFrame(function() {
    for (var e = 2; 100 > e; e++) pizzasDiv.appendChild(pizzaElementGenerator(e))
}),
